...
const Contact = () => {
  ...
  const submitData = async (event) => {
    ...
    if (firstName && lastName && phone && email && address && message) {
      const res = fetch(
         "https://reactfirebase-a7c7e-default-rtdb.firebaseio.com/userDataRecords.json",
        {
          method: "POST",
          headers: {
          ...
          <div className="contact-rightside col-12 col-lg-7">
                ...
                <div className="row">
                    ...
                    <div className="col-12">
                          ...
                          name="address"
                          id=""
                          className="form-control contact-input-filed"
                 ...
                 </div>                                                                    {/*--btn property sign up,submit\\\--*/}
                      <button type="submit" className="btn btn-style  text-center w-50"
                              onClick={submitData}>  
                        Submit
                      </button>
                 </form>
